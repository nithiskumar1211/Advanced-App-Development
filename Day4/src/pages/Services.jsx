  ...
  return (
    <div>
      <section
        ...
        style={{
          backgroundImage:
            "url('https://res.cloudinary.com/dwyfsuuzs/image/upload/v1710792566/wedding-packages-98ee11e0-3973-429c-8a50-6b453a063da8_mjy027.jpg')",
        }}
      >
        <div className="banner-content">
          <h1 className="banner-name-1" style={{fontSize:'35px',color:'brown'}}>Birthday  <span style={{color:"black"}}>Parties</span></h1>
          <span></span>
        </div>
      </section>
          ...
          <div className="photography-incontainer decor-incontainer">
            <div className="secheader animated fadeInDown">
              <h2 className="sec_head">
                Birthday
                <span style={{color:'red'}}> Decorations</span>
              </h2>
              <p style={{color:'grey'}}>
        ...
        <div className="container">
          <div className="photography-incontainer decor-incontainer">
            <div className="secheader animated fadeInDown">
              <h2 className="sec_head">
                Birthday
                <span style={{color:'red'}}> Photography</span>
              </h2>
              <p style={{color:'grey'}}>
        ...
        <div className="container">
          <div className="photography-incontainer decor-incontainer">
            <div className="secheader animated fadeInDown">
              <h2 className="sec_head">
                Birthday
                <span style={{color:'red'}}> Cakes</span>
              </h2>
              <p style={{color:'grey'}}>
        ...
        <div className="container">
          <div className="photography-incontainer decor-incontainer">
            <div className="secheader animated fadeInDown">
              ...
              <p style={{color:'grey'}}>Curated birthday gift ideas for everyone. </p>
            </div>
            <div className="services-container-1">
              <div className="decor-item">
                <a href="">
            ...
            <div className="services-container-1">
              <div className="decor-item">
                <a href="">
                  <div className="decor-img">
                    <img
                      src="https://res.cloudinary.com/dwyfsuuzs/image/upload/v1710821190/f1_ylvphv.jpg"
                      alt="Birthday-Balloon Decorations"
                    />
                  </div>
                  <div className="decor-cont">
              ...
              <div className="decor-item">
                <a href="">
                  <div className="decor-img">
                    <img
                      src="https://res.cloudinary.com/dwyfsuuzs/image/upload/v1710821314/F2_zcezdd.jpg"
                      alt=""
                    />
                  </div>
                  <div className="decor-cont">
